...
*/
    ...
    if ((m = error =~ /E\s(.+?)\s\[(\d{3})\s(.*?)\]/)) {
        ...
        jsonLog += "{\"DOCURL\":\""+JSONValue.escape(m[0][1])+"\", \"e_group\":\"HTTP status code error\", \"e_type_pretty\":\"HTTP "+JSONValue.escape(m[0][2])+"\", \"e_type\":\"HTTP error\", \"e_http-status-code\":\""+JSONValue.escape(m[0][2])+"\", \"e_msg\":\""+JSONValue.escape(m[0][3])+"\"}\n"
        ...
        // Java errors
         ...
         switch (m[0][2]) {
            ...
            case { it.startsWith("Crawl URLs: java.lang.IllegalArgumentException: unexpected url") }:
                ...
                jsonLog += "{\"DOCURL\":\""+JSONValue.escape(m[0][1])+"\", \"e_group\":\"Web crawler error\", \"e_type_pretty\":\"Unexpected URL\", \"e_type\":\"cr_unexpected-url\", \"e_msg\":\""+JSONValue.escape(m[0][2])+"\"}\n"
                break
            ...
            case { it.startsWith("Crawl URLs: java.lang.NullPointerException") || it.startsWith("Crawl URLs: java.lang.RuntimeException: java.lang.NullPointerException") }:
                ...
                jsonLog += "{\"DOCURL\":\""+JSONValue.escape(m[0][1])+"\", \"e_group\":\"Web crawler error\", \"e_type_pretty\":\"NullPointerException\", \"e_type\":\"cr_null-pointer-exception\", \"e_msg\":\""+JSONValue.escape(m[0][2])+"\"}\n"
                break
            ...
            case { it.startsWith("Crawl URLs: java.lang.RuntimeException: java.lang.ClassCastException: org.apache.pdfbox.cos.COSInteger cannot be cast to org.apache.pdfbox.cos.COSObject") }:
                ...
                jsonLog += "{\"DOCURL\":\""+JSONValue.escape(m[0][1])+"\", \"e_group\":\"Web crawler error\", \"e_type_pretty\":\"PDF box class cast exception\", \"e_type\":\"cr_class-cast-exception\", \"e_msg\":\""+JSONValue.escape(m[0][2])+"\"}\n"
                break
            ...
            case { it.startsWith("Crawl URLs: java.lang.RuntimeException: java.lang.IllegalArgumentException: Metadata keys must not contain white space invalid key is:") }:
                ...
                jsonLog += "{\"DOCURL\":\""+JSONValue.escape(m[0][1])+"\", \"e_group\":\"Web crawler error\", \"e_type_pretty\":\"Metadata key containing white space\", \"e_type\":\"cr_metadata-key-containing-white-space\", \"e_msg\":\""+JSONValue.escape(m[0][2])+"\"}\n"
                break
            ...
            case { it.startsWith("Crawl URLs: java.lang.RuntimeException: java.lang.IllegalArgumentException: String must not be empty") }:
                ...
                jsonLog += "{\"DOCURL\":\""+JSONValue.escape(m[0][1])+"\", \"e_group\":\"Web crawler error\", \"e_type_pretty\":\"String must not be empty\", \"e_type\":\"cr_metadata-string-must-not-be-empty\", \"e_msg\":\""+JSONValue.escape(m[0][2])+"\"}\n"
                break
            ...
            case { it.startsWith("Crawl URLs: java.lang.RuntimeException: java.net.URISyntaxException: Illegal character in path") }:
                ...
                jsonLog += "{\"DOCURL\":\""+JSONValue.escape(m[0][1])+"\", \"e_group\":\"Web crawler error\", \"e_type_pretty\":\"Illegal character in path\", \"e_type\":\"cr_url-syntax-illegal-character-in-path\", \"e_msg\":\""+JSONValue.escape(m[0][2])+"\"}\n"
                break
            ...
            case { it.startsWith("Crawl URLs: java.lang.RuntimeException: java.net.URISyntaxException: Illegal character in query") }:
                ...
                jsonLog += "{\"DOCURL\":\""+JSONValue.escape(m[0][1])+"\", \"e_group\":\"Web crawler error\", \"e_type_pretty\":\"Illegal character in query string\", \"e_type\":\"cr_url-syntax-illegal-character-in-query\", \"e_msg\":\""+JSONValue.escape(m[0][2])+"\"}\n"
                break
            ...
            case { it.startsWith("Crawl URLs: java.lang.RuntimeException: groovy.lang.MissingPropertyException: No such property") }:
                ...
                jsonLog += "{\"DOCURL\":\""+JSONValue.escape(m[0][1])+"\", \"e_group\":\"Web crawler error\", \"e_type_pretty\":\"No such property\", \"e_type\":\"cr_url-missing-property\", \"e_msg\":\""+JSONValue.escape(m[0][2])+"\"}\n"
                break

            case { it.startsWith("Crawl URLs: java.lang.OutOfMemoryError: Java heap space") }:
                errorCounter["cr_java-heap-space"]++
                jsonLog += "{\"DOCURL\":\""+JSONValue.escape(m[0][1])+"\", \"e_group\":\"Web crawler error\", \"e_type_pretty\":\"Out of memory\", \"e_type\":\"cr_java-heap-space\", \"e_msg\":\""+JSONValue.escape(m[0][2])+"\"}\n"
                break
                
            case { it.startsWith("Crawl URLs: java.lang.OutOfMemoryError: GC overhead limit exceeded") }:
                errorCounter["cr_java-gc-overhead"]++
                jsonLog += "{\"DOCURL\":\""+JSONValue.escape(m[0][1])+"\", \"e_group\":\"Web crawler error\", \"e_type_pretty\":\"GC overhead limit exceeded\", \"e_type\":\"cr_java-gc-overhead\", \"e_msg\":\""+JSONValue.escape(m[0][2])+"\"}\n"
                break

            case { it.startsWith("Crawl URLs: java.lang.StackOverflowError") }:
                errorCounter["cr_stack-overflow"]++
                jsonLog += "{\"DOCURL\":\""+JSONValue.escape(m[0][1])+"\", \"e_group\":\"Web crawler error\", \"e_type_pretty\":\"StackOverflowError\", \"e_type\":\"cr_metadata-key-containing-white-space\", \"e_msg\":\""+JSONValue.escape(m[0][2])+"\"}\n"
                break

            default:
                errorCounter["cr_unknown"]++
                jsonLog += "{\"DOCURL\":\""+JSONValue.escape(m[0][1])+"\", \"e_group\":\"Web crawler error\", \"e_type_pretty\":\"Unknown\", \"e_type\":\"cr_unknown\", \"e_msg\":\""+JSONValue.escape(m[0][2])+"\"}\n"
                break
        }
    }
        ...
        switch (m[0][2]) {
            ...
            case { it.startsWith("Link Extraction: java.net.MalformedURLException: For input string:") }:
                ...
                jsonLog += "{\"DOCURL\":\""+JSONValue.escape(m[0][1])+"\", \"e_group\":\"Link extraction error\", \"e_type_pretty\":\"Malformed input string\", \"e_type\":\"le_malformed-input-string\", \"e_msg\":\""+JSONValue.escape(m[0][2])+"\"}\n"
                break

            case { it.startsWith("Link Extraction: java.net.MalformedURLException: Invalid host:") }:
                errorCounter["le_invalid-host"]++
                jsonLog += "{\"DOCURL\":\""+JSONValue.escape(m[0][1])+"\", \"e_group\":\"Link extraction error\", \"e_type_pretty\":\"Inavlid host\", \"e_type\":\"le_invalid-host\", \"e_msg\":\""+JSONValue.escape(m[0][2])+"\"}\n"
                break

            case { it.startsWith("Link Extraction: java.net.MalformedURLException: no protocol:") }:
                errorCounter["le_no-protocol"]++
                jsonLog += "{\"DOCURL\":\""+JSONValue.escape(m[0][1])+"\", \"e_group\":\"Link extraction error\", \"e_type_pretty\":\"No protocol\", \"e_type\":\"le_no-protocol\", \"e_msg\":\""+JSONValue.escape(m[0][2])+"\"}\n"
                break               

            default:
                errorCounter["le_unknown"]++
                jsonLog += "{\"DOCURL\":\""+JSONValue.escape(m[0][1])+"\", \"e_group\":\"Link extraction error\", \"e_type_pretty\":\"Unknown\", \"e_type\":\"le_unknown\", \"e_msg\":\""+JSONValue.escape(m[0][2])+"\"}\n"
                break
        }       
    }
        ...
        switch (m[0][2]) {
            ...
            case "Connection establishment timed out":
                ...
                jsonLog += "{\"DOCURL\":\""+JSONValue.escape(m[0][1])+"\", \"e_group\":\"Network error\", \"e_type_pretty\":\"Connection timeout\", \"e_type\":\"ne_connection-timeout\", \"e_msg\":\""+JSONValue.escape(m[0][2])+"\"}\n"
                break

            case "Read timed out":
                errorCounter["ne_read-timeout"]++
                jsonLog += "{\"DOCURL\":\""+JSONValue.escape(m[0][1])+"\", \"e_group\":\"Network error\", \"e_type_pretty\":\"Read timeout\", \"e_type\":\"ne_read-timeout\", \"e_msg\":\""+JSONValue.escape(m[0][2])+"\"}\n"
                break

            case "Connection reset":
                errorCounter["ne_connection-reset"]++
                jsonLog += "{\"DOCURL\":\""+JSONValue.escape(m[0][1])+"\", \"e_group\":\"Network error\", \"e_type_pretty\":\"Connection reset\", \"e_type\":\"ne_connection-reset\", \"e_msg\":\""+JSONValue.escape(m[0][2])+"\"}\n"
                break   

            case "No route to host":
                errorCounter["ne_no-route-to-host"]++
                jsonLog += "{\"DOCURL\":\""+JSONValue.escape(m[0][1])+"\", \"e_group\":\"Network error\", \"e_type_pretty\":\"No route to host\", \"e_type\":\"ne_no-route-to-host\", \"e_msg\":\""+JSONValue.escape(m[0][2])+"\"}\n"
                break   

            case { it.startsWith("Unsupported protocol") }:
                errorCounter["ne_unsupported-protocol"]++
                jsonLog += "{\"DOCURL\":\""+JSONValue.escape(m[0][1])+"\", \"e_group\":\"Network error\", \"e_type_pretty\":\"Unsupported protocol\", \"e_type\":\"ne_unsupported-protocol\", \"e_msg\":\""+JSONValue.escape(m[0][2])+"\"}\n"
                break            

            case "Premature EOF encountered":
                errorCounter["ne_premature-eof"]++
                jsonLog += "{\"DOCURL\":\""+JSONValue.escape(m[0][1])+"\", \"e_group\":\"Network error\", \"e_type_pretty\":\"Encountered premature EOF\", \"e_type\":\"ne_premature-eof\", \"e_msg\":\""+JSONValue.escape(m[0][2])+"\"}\n"
                break   

            case { it.endsWith("unknown error") }:
                errorCounter["ne_unknown"]++
                jsonLog += "{\"DOCURL\":\""+JSONValue.escape(m[0][1])+"\", \"e_group\":\"Network error\", \"e_type_pretty\":\"Unspecified network error\", \"e_type\":\"ne_unknown\", \"e_msg\":\""+JSONValue.escape(m[0][2])+"\"}\n"
                break
            ...
            case "Connection has been shutdown: javax.net.ssl.SSLHandshakeException: Received fatal alert: handshake_failure":
                ...
                jsonLog += "{\"DOCURL\":\""+JSONValue.escape(m[0][1])+"\", \"e_group\":\"Network error\", \"e_type_pretty\":\"SSL handshake failure\", \"e_type\":\"ne_ssl-handshake\", \"e_msg\":\""+JSONValue.escape(m[0][2])+"\"}\n"
                break
            ...
            case "Connection has been shutdown: javax.net.ssl.SSLException: Received fatal alert: close_notify":
                ...
                jsonLog += "{\"DOCURL\":\""+JSONValue.escape(m[0][1])+"\", \"e_group\":\"Network error\", \"e_type_pretty\":\"SSL close notify\", \"e_type\":\"ne_ssl-close-notify\", \"e_msg\":\""+JSONValue.escape(m[0][2])+"\"}\n"
                break

            default:
                errorCounter["ne_other"]++
                jsonLog += "{\"DOCURL\":\""+JSONValue.escape(m[0][1])+"\", \"e_group\":\"Network error\", \"e_type_pretty\":\"Unknown\", \"e_type\":\"ne_other\", \"e_msg\":\""+JSONValue.escape(m[0][2])+"\"}\n"
                break
        }       
    }   
        ...
        jsonLog += "{\"DOCURL\":\""+JSONValue.escape(m[0][1])+"\", \"e_group\":\"General error\", \"e_type_pretty\":\"Rejected due to configured file size limit\", \"e_type\":\"e_file-size\", \"e_msg\":\"Exceeds maximum file size\", \"file-size\":\""+JSONValue.escape(size.toString())+"\"}\n"
    }   
        ...
        switch (m[0][2]) {
            ...
            case "Contains robots NOFOLLOW tag":
                ...
                jsonLog += "{\"DOCURL\":\""+JSONValue.escape(m[0][1])+"\", \"e_group\":\"General error\", \"e_type_pretty\":\"Skipped due to robots no-follow tag\", \"e_type\":\"e_robots-nofollow\", \"e_msg\":\""+JSONValue.escape(m[0][2])+"\"}\n"
                break

            case "Can't scan root page":
                errorCounter["e_root-page"]++
                jsonLog += "{\"DOCURL\":\""+JSONValue.escape(m[0][1])+"\", \"e_group\":\"General error\", \"e_type_pretty\":\"Can't scan root page\", \"e_type\":\"e_root-page\", \"e_msg\":\""+JSONValue.escape(m[0][2])+"\"}\n"
                break

            case "Can't get text signature":
                errorCounter["e_text-signature"]++
                jsonLog += "{\"DOCURL\":\""+JSONValue.escape(m[0][1])+"\", \"e_group\":\"General error\", \"e_type_pretty\":\"Can't get text signature\", \"e_type\":\"e_text-signature\", \"e_msg\":\""+JSONValue.escape(m[0][2])+"\"}\n"
                break

            case "Parser timed out":
                errorCounter["e_parser-timeout"]++
                jsonLog += "{\"DOCURL\":\""+JSONValue.escape(m[0][1])+"\", \"e_group\":\"General error\", \"e_type_pretty\":\"Parser timed out\", \"e_type\":\"e_parser-timeout\", \"e_msg\":\""+JSONValue.escape(m[0][2])+"\"}\n"
                break

            case "Reached store limit":
                errorCounter["e_store-limit"]++
                jsonLog += "{\"DOCURL\":\""+JSONValue.escape(m[0][1])+"\", \"e_group\":\"General error\", \"e_type_pretty\":\"Reached store limit\", \"e_type\":\"e_store-limit\", \"e_msg\":\""+JSONValue.escape(m[0][2])+"\"}\n"
                break

            default:
                errorCounter["e_unknown"]++
                jsonLog += "{\"DOCURL\":\""+JSONValue.escape(m[0][1])+"\", \"e_group\":\"General error\", \"e_type_pretty\":\"Unknown\", \"e_type\":\"e_unknown\", \"e_msg\":\""+JSONValue.escape(m[0][2])+"\"}\n"
                break               
        }
    }
